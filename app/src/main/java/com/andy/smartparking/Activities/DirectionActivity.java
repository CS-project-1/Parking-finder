...
import com.andy.smartparking.Adapter.DirectionAdapter;
import com.andy.smartparking.Constant.AllConstant;
import com.andy.smartparking.DirectionsModel.DirectionLegModel;
import com.andy.smartparking.DirectionsModel.DirectionResponseModel;
import com.andy.smartparking.DirectionsModel.DirectionRouteModel;
...
import com.andy.smartparking.databinding.ActivityDirection2Binding;
import com.andy.smartparking.databinding.BottomSheetBinding;
...
public class DirectionActivity extends AppCompatActivity implements OnMapReadyCallback {
    private ActivityDirection2Binding binding;
//    private GoogleMap mGoogleMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDirection2Binding.inflate(getLayoutInflater());
    ...
    private void getDirection(String mode) {
        if (isLocationPermissionOk) {
            ...
            String url = "https://maps.googleapis.com/maps/api/directions/json?" +
                    ...
                    "&mode=" + mode +
                    "&key=" + getResources().getString(R.string.directionsApi);
...
//                                getSupportActionBar().setTitle(routeModel.getSummary());
                                ...
                                mGoogleMap.addMarker(new MarkerOptions()
                                        .position(new com.google.android.gms.maps.model.LatLng(legModel.getStartLocation().getLat(), legModel.getStartLocation().getLng()))
                                        .title("Start Location"));

                                mGoogleMap.addMarker(new MarkerOptions()
                                        .position(new com.google.android.gms.maps.model.LatLng(legModel.getEndLocation().getLat(), legModel.getEndLocation().getLng()))
                                        .title("End Location"));
...
//
                                ...
                                List<com.google.android.gms.maps.model.LatLng> stepList = new ArrayList<>();
                                ...
                                for (DirectionStepModel stepModel : legModel.getSteps()) {
                                    ...
                                    for (com.google.maps.model.LatLng latLng : decodedLatLng) {
                                        stepList.add(new com.google.android.gms.maps.model.LatLng(latLng.lat, latLng.lng));
                                    }
                                }
                                ...
                                com.google.android.gms.maps.model.LatLng startLocation = new com.google.android.gms.maps.model.LatLng(legModel.getStartLocation().getLat(), legModel.getStartLocation().getLng());
//                                com.android.gms.maps.model
                                com.google.android.gms.maps.model.LatLng endLocation = new com.google.android.gms.maps.model.LatLng(legModel.getStartLocation().getLat(), legModel.getStartLocation().getLng());


                                mGoogleMap.animateCamera(CameraUpdateFactory.newLatLngBounds(new LatLngBounds(startLocation,endLocation),17));
//                                new LatLngBounds(startLocation, endLocation), 17)
